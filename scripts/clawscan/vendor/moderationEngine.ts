// Vendored from openclaw/clawhub (MIT) — DO NOT EDIT.
// Source: https://github.com/openclaw/clawhub/blob/main/convex/lib/moderationEngine.ts
// Commit: 60b02c09f9361d7bcaac347877287d055560c12b (2026-08-12T19:19:37Z)
// Engine version: v2.4.26
// Local patch: relative import "./moderationReasonCodes" -> "./moderationReasonCodes.js"
//   (Node --experimental-strip-types requires explicit extensions; the clawscan loader
//    remaps .js -> .ts for this directory).
// Update: re-download from the commit above and re-apply the import patch.
